<template>
  <div>
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column prop="publishTime" label="出版时间" width="300"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="30%"
      ...
      <el-form :model="entity">
        ...
        <el-form-item label="ISBN" label-width="150px">
          <el-input v-model="entity.isbn" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="出版商" label-width="150px">
          <el-input v-model="entity.publisher" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="出版时间" label-width="150px">
          <el-input v-model="entity.publishTime" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>

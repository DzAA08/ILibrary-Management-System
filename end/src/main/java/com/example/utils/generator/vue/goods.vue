<template>
  <div>
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column prop="imgs" label="商品图片"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="30%"
      ...
      <el-form :model="entity">
        ...
        <el-form-item label="点赞数" label-width="150px">
          <el-input v-model="entity.praise" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="销量" label-width="150px">
          <el-input v-model="entity.sales" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
        ...
        <el-form-item label="商品图片" label-width="150px">
          <el-input v-model="entity.imgs" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
